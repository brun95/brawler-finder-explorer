      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex md:items-center md:space-x-4">
            <GlobalSearch />
            <Link href="/dashboard" className="text-gray-700 dark:text-gray-300 hover:text-primary transition-colors flex items-center gap-1">
            ...
            <Link href="/brawlers" className="text-gray-700 dark:text-gray-300 hover:text-primary transition-colors">
              Brawlers
            </Link>
            <Link href="/maps" className="text-gray-700 dark:text-gray-300 hover:text-primary transition-colors">
              Maps
            </Link>
